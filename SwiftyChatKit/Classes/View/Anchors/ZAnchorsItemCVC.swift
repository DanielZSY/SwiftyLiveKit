...
class ZAnchorsItemCVC: ZBaseCVC {
    ...
    private lazy var z_imagedown: UIImageView = {
        ...
        z_temp.image = Asset.defaultTransparentDown.image
        return z_temp
    }()
    ...
    final func func_setcvcmodel(model: ZModelUserInfo) {
        ...
        z_imagephoto.setImageWitUrl(strUrl: model.avatar, placeholder: Asset.defaultImage.image)
