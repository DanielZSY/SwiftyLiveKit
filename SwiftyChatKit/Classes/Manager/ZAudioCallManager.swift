...
/// 音频播放管理
class ZAudioCallManager: NSObject {
    
    /// 静态模式
    public static let shared = ZAudioCallManager()
    /// 是否播放中
    ...
    /// 开始播放声音
    public final func playSound(name: String) {
        self.stopSound()
...
extension ZAudioCallManager: AVAudioPlayerDelegate {
